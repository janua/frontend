...
class GuardianConfiguration(val application: String, val webappConfDirectory: String = "env") extends Logging {
  ...
  object ajax {
    ...
    lazy val corsOrigins: Seq[String] = configuration.getStringProperty("ajax_cors_origin").map(_.split(",")
  ...
  object images {
    ...
    object backends {
      lazy val mediaToken: String = configuration.getMandatoryStringProperty("images_media_token")
  ...
  object facebook {
    lazy val appId = configuration.getMandatoryStringProperty("guardian_page_fbAppId")
  ...
  object commercial {
    lazy val dfpAdUnitRoot = configuration.getMandatoryStringProperty("guardian_page_dfpAdUnitRoot")
    lazy val dfpAccountId = configuration.getMandatoryStringProperty("guardian_page_dfpAccountId")
